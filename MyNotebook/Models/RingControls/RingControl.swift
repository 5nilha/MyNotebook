...
class RingControl: UIView {
    ...
    func setupRings(itemCount: Int) {
        ...
        let borderColorSelected = #colorLiteral(red: 0.6642242074, green: 0.6642400622, blue: 0.6642315388, alpha: 1).cgColor
        let borderColorNormal = UIColor.darkGray.cgColor
        let fillColorSelected = #colorLiteral(red: 0.8374180198, green: 0.8374378085, blue: 0.8374271393, alpha: 1)
